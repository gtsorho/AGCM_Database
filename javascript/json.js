$(document).ready(function(){
    ...
    $('#submit2').on( 'click', function(e){
        ...
        if(!fname||!sname||!email||!sex||!dbirth||!programme||!department||!phone||!residence){
            $('#alert').show();
            ...
            $.ajax({
                ...
                method: 'post',
                data: {"fname":fname,"sname":sname,"othernames":othernames, "email":email,"sex":sex, "dbirth":dbirth,"programme":programme, 
